...
todo $N \ge 1$, toda função teste $f \in C^1$ e todo $\psi$,
\begin{equation}
...
\end{align}
Como os tensores são isometrias parciais (com $\|A\|=1$), a desigualdade
triangular dá
\begin{align}
  \bigl\|J_N^a(f)\,\psi\bigr\|
  &\le \sum_{\ell=0}^{N}\, Z_\ell
  \sum_{n}\, \bigl\|\mathcal{D}_{\ell \to 0}\!\bigl[\mathcal{J}^a_{A_{\ell,n}}(f)\bigr]\,\psi\bigr\| \nonumber \\
  &\le \sum_{\ell=0}^{N}\, b^{-\ell}\, N_\ell\,
  \bigl(6\,b^\ell\,\|f'\|_\infty\bigr)\,\|\psi\|.
\end{align}
Aqui $N_\ell$ é o número de tensores da camada $\ell$ que contribuem
para a corrente. Por densidade-por-sítio numa MERA escala-invariante,
\(
  N_\ell = b^{-\ell}\,|\Lambda_{\mathrm{UV}}|,
\)
onde $|\Lambda_{\mathrm{UV}}|$ é o número de sítios na camada UV.
A corrente $J_N^a(f)$ é, por construção, um operador
\emph{intensivo} (densidade): o factor de volume $|\Lambda_{\mathrm{UV}}|$
é absorvido na convenção da função teste $f$ (que vive como um
funcional sobre a rede UV). Tirando esse factor extensivo, o que
contribui em norma operatorial por unidade de volume é
\begin{align}
  \bigl\|J_N^a(f)\,\psi\bigr\|
  &\le \sum_{\ell=0}^{N}\, b^{-\ell}\,b^{-\ell}\,
  \bigl(6\,b^\ell\,\|f'\|_\infty\bigr)\,\|\psi\| \nonumber \\
  &= 6\,\|f'\|_\infty\,\|\psi\|\, \sum_{\ell=0}^{N} b^{-\ell}.
\end{align}
A soma geométrica é controlada por
\(
  \sum_{\ell=0}^{N} b^{-\ell} \le \frac{b}{b-1}.
\)
Daí,
\[
  \bigl\|J_N^a(f)\,\psi\bigr\|
  \le 6 \cdot \frac{b}{b-1}\,\|f'\|_\infty\,\|\psi\|.
\]
Para $b=2$, isto dá $C_2 = 6 \cdot 2 = 12$; para $b=3$, $C_3 = 6 \cdot 3/2 = 9$.
